...
<body>
	<div class="b_container">
		...
		<div class="b_header">
			<div class="logo">
				<i class="fa fa-hospital-o"></i>	健康平台管理系统
			</div>
			<div class="loginInfo">
				 欢迎您${manager.job_number }  
				<a href="/manager/logout">注销</a>
			</div>
		</div>
		<!-- 头部结束 -->
		<!-- 内容区开始 -->
		<div class="b_content">
			<div class="b_left">
				<dl class="menu">
					...
					<dd url='/dealPatient/findUnDealdPatient/${user.id }'><a href="javascript:void(0)">科室未处理病人</a></dd>
					<dd url='/dealPatient/findDealdPatient/${user.id}'><a href="javascript:void(0)">已处理挂号病人</a></dd>
					<dd url='/patientDrug/toOpenRecipe'><a href="javascript:void(0)">开处方</a></dd>
					<dd url='/recipe/toRecipeSelect'><a href="javascript:void(0)">处方查询</a></dd>
					<dd url='/patientPhysicalexam/toOpenInspection'><a href="javascript:void(0)">开检查</a></dd>
					<dd url='/inspection/toInspectionSelect'><a href="javascript:void(0)">检查查询</a></dd>
					<dd url='/dealPatient/toDiagnosePatient'><a href="javascript:void(0)">诊断病人</a></dd>
					<dd url='/medicalRecord/toMedicalRecordSelect'><a href="javascript:void(0)">病例档案查询</a></dd>
					...
					<dd url='/medicalTechnology/entryCheckResult'><a href="javascript:void(0)">录入检查结果</a></dd>
					...
					<dd url='/userPatient/findUserPatient'><a href="javascript:void(0)">门诊挂号</a></dd>
					<dd url='/physicalexam/findAllphysicalExam'><a href="javascript:void(0)">辅助检查项目管理</a></dd>
					<dd url='/userPatient/findAllPatient'><a href="javascript:void(0)">就诊卡充值扣费</a></dd>
